...
[espeak](http://espeak.sourceforge.net/) လိုခေါ်တဲ့ formant synthesis နည်းပညာကို သုံးထားတဲ့ text to speak ပရိုဂရမ် အသေးလေး တစ်ခု ရှိပါတယ်။ quality ကတော့ သဘာဝအသံလိုမျိုး မဟုတ်ပဲ ဟိုးအရင်က ရုပ်ရှင်တွေထဲမှာ စက်ရုပ်က စကားပြောတဲ့ အသံလိုပဲ ထွက်ပေးနိုင်ပါတယ်။ ဘာသာပေါင်း တော်တော်များများကို support လုပ်ပါတယ်။ သို့သော် espeak မှာ လက်ရှိ ဗမာစာအတွက် မရှိသေးလို့ ကျွန်တော် experiment တစ်ခုအနေနဲ့ လုပ်ဖြစ်ခဲ့ပေမဲ့ အများသုံးလို့ ရအောင် share တော့ မလုပ်ဖြစ်သေးပါဘူး။ တော်တော်တော့ ကြာပါပြီ။ အဲဒီနောက်ပိုင်းမှာ espeak-ng ဆိုပြီးထွက်လာတဲ့ အခါမှာတော့ ဗမာစာအတွက် လုပ်ထားတာကိုလည်း တွေ့ရပေမဲ့ သုံးကြည့်တော့ အဆင်မပြေသေးတာကို တွေ့ရပါတယ်။ ဒီနေရာမှာတော့ အဲဒီ espeak နဲ့ zenity GUI ကို တွဲပြီး သုံးပြထားတဲ့ bash script ဖြစ်ပါတယ်။  
...
အထက်ပါ output ကို လေ့လာကြည့်ရင် "နယူတန်" ဆိုတဲ့ စာလုံးက အဘိဓာန်ထဲမှာ မရှိလို့ spelling mistake word အနေနဲ့ ပြသပေးတာပါ။  
ထိုနည်းလည်းကောင်း တကယ် စာလုံးပေါင်း မှားနေတဲ့ "အင်ဂလိပ်" ဆိုတဲ့ စာလုံးအမှားကိုလည်း ဆွဲထုတ်ပေးနိုင်တာကို တွေ့ရပါလိမ့်မယ်။  
...
JSON ဖိုင်က ဒီ GitHub link [https://github.com/burma-project-ideas/myanmar-proverbs](https://github.com/burma-project-ideas/myanmar-proverbs) ကနေ download လုပ်ထားတာ။  

အရင်ဆုံး JSON ဖိုင်ရဲ့ structure ကို ကြည့်ကြည့်ရအောင် ...  

```
(base) ye@lst-gpu-server-197:~/ye/data/my-proverb$ jq 'walk(if type == "object" then with_entries(.value |= null) else . end)' ./MyanmarProverbs.json
{
  "Tbl_MMProverbsTitle": null,
  "Tbl_MMProverbs": null
}
```

```
(base) ye@lst-gpu-server-197:~/ye/data/my-proverb$ head ./MyanmarProverbs.json
{
  "Tbl_MMProverbsTitle": [
    {
      "TitleId": 1,
...
(base) ye@lst-gpu-server-197:~/ye/data/my-proverb$
```

```
(base) ye@lst-gpu-server-197:~/ye/data/my-proverb$ tail ./MyanmarProverbs.json
...
ရေးထားတဲ့ bash script [extract_key_value_of_json.sh](https://github.com/ye-kyaw-thu/tools/blob/master/bash/extract_key_value_of_json.sh)  နဲ့ ကိုယ်လိုချင်တဲ့ field တွေပဲ ဆွဲထုတ်ယူမယ်။  

```
(base) ye@lst-gpu-server-197:~/ye/data/my-proverb$ chmod +x ./extract.sh
(base) ye@lst-gpu-server-197:~/ye/data/my-proverb$ ./extract.sh
```

ဆွဲထုတ်ပြီး pipe သုံးခုနဲ့ paste လုပ်ထားတဲ့ output က အောက်ပါအတိုင်းပါ။  

```
(base) ye@lst-gpu-server-197:~/ye/data/my-proverb$ head extracted.out
1|||က ချင်လျှက်လက်ကျိုး|||က ချင်သူသည် ကရခါနီးမှ လက်ကျိုးသဖြင့် မကလိုက်ရ ဖြစ်သကဲ့သို့ မိမိ အစွမ်းအစကို ပြမည် ဟု အားခဲထားသူသည် အစွမ်းအစကို ပြရခါနီးမှ အကြောင်းမညီညွတ်သောကြောင့် မပြလိုက်ရ ဖြစ်သည်။ (က ချင်လျက် လက်နာ - ဟူ၍လည်း အသုံး ရှိသည်။)
2|||ကတွတ်ပေါက် ဗျိုင်းစောင့်|||ဗျိုင်းသည် ကတွတ်ပေါက်မှ တက်လာမည့် ငါးကိုဖမ်းရန် စောင့်မျှော်နေသကဲ့သို့ အခွင့်အလမ်း တစ်စုံတစ်ရာကို မျှော်လင့်ခြင်း ကြီးစွာဖြင့် စောင့်ကြည့်နေသည်။ (ကတွတ်ဝ ဗျိုင်းစောင့်၊ ဆည်ဝ ဗျိုင်းစောင့် - ဟူ၍လည်း အသုံးရှိသည်။)
3|||က ရိုး မက ဆန်း၍က နှပ်ပစ်ခံရ|||ကချေသည်သည် ကနေကျအတိုင်း မကဘဲ ဆန်းပြားစွာကမိသောကြောင့် ပရိသတ်၏ ကိုယ်ထိ လက်ရောက် ရှုတ်ချခြင်း ခံရသကဲ့သို့ မိမိအလုပ်ကို လုပ်နေကျအတိုင်း မလုပ်ဘဲ မဆင်မခြင် ဆန်း ပြားစွာ ပြုလုပ်မိသောကြောင့် ပြစ်တင်ရှုတ်ချခြင်း ခံရသည်။
4|||ကလိမ်စေ့ ငြမ်းဆင်|||စေတီပုထိုးအဆောက်အအုံများကိုသာ ငြမ်းဆင်ရမြဲ ဖြစ်သည်။ ကလိမ်စေ့သည် ငြမ်းဆင်ရသော အရာမဟုတ်။ ထိုသို့ မဟုတ်ပါဘဲလျက် ကလိမ်စေ့ကို ငြမ်းဆင်သည်ဟု ဆိုသကဲ့သို့ ယုတ္တိမတန်သော စကားကို လှည့်ပတ် ပြောဆိုသည်။
5|||ကုသိုလ်တစ်ပဲ ငရဲတစ်ပိဿာ|||ကုသိုလ်ဖြစ်စေရန် ရည်ရွယ်ချက်ဖြင့် လုပ်သော်လည်း လုပ်ပုံကိုင်ပုံ မလျော်ကန်လျှင် အကုသိုလ် များစွာ ဖြစ်ရသကဲ့သို့ ကောင်းစေလို၍ လုပ်သော်လည်း လုပ်ပုံကိုင်ပုံ မလျော်ကန်လျှင် အကျိုးထက် အပြစ်က များစွာပိုဖြစ်သည်။
6|||ကုသိုလ်ဖန် ဗိမာန်အသင့် ဘုံအသင့်|||ကုသိုလ်ကံ ဖန်တီးပေးသူအဖို့ ဘုံဗိမာန် အသင့်ဖြစ်နေသကဲ့သို့ ကံကောင်းသူအဖို့ အရာရာမှာ အဆင်သင့် ဖြစ်နေတတ်သည်။
7|||ကုသိုလ်လည်း ရ ဝမ်းလည်း ဝ|||ကောင်းသော အသက်မွေးခြင်းဖြင့် ကုသိုလ်လည်းရ ဝမ်းလည်းဝ သကဲ့သို့ ကောင်းသောအမှုကို သူတစ်ပါးအတွက် စေတနာကောင်းနှင့် ဆောင်ရွက် ပးခြင်းဖြင့် မိမိအကျိုးလည်း တစ်ပါတည်း ပြည့်စုံသည်။
8|||ကံကောင်းတဲ့ကျား သွားရင်း သမင်တွေ့|||ကံကောင်းသော ကျားသည် သွားရင်းလာရင်း မမျှော်လင့်ဘဲ သမင်နှင့် ပက်ပင်းတိုး၍ သမင်သား စားရသကဲ့သို့ ကံကောင်းသူသည် မမျှော်လင့်ဘဲ အခွင့်ကောင်းနှင့် ကြုံတွေ့ရသည်။ (ကံကောင်းတဲ့ကျား သားကောင်နှင့် ရင်ဆိုင်တွေ့ - ဟူ၍လည်း အသုံးရှိသည်။)
9|||ကံဆိုးမှသွားရာမိုးလိုက်လို့ရွာ|||ကံဆိုးမှ သွားလေရာအရပ်တိုင်း မိုးလိုက်၍ရွာ ဆိုသကဲ့သို့ ကံဆိုးသူအား ဒုက္ခမျိုးစုံက ထက်ကြပ် မကွာ လိုက်လံ ဒုက္ခပေးသည်။
10|||ကံမခိုင် သံတိုင်အိမ်ဆောက်သော်လည်း ကံမှောက်လျှင်ကျိုး|||ကုသိုလ်ကံ ဇာတာညံ့နေသည့်အချိန် ဖြစ်ပါက သံတိုင်ကို တိုင်ထူ၍ အိမ်ဆောက်စေကာမူ သံတိုင် ကျိုးသည့်အဖြစ် ကြုံရသကဲ့သို့ မူလအခြေခံညံ့ဖျင်းလျှင် လုပ်သမျှ အရာမထင် ဖြစ်တတ်သည်။
(base) ye@lst-gpu-server-197:~/ye/data/my-proverb$
```
