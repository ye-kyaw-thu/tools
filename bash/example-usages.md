...
```
ရေးထားတာက soxi နဲ့ 16 KHz အဖြစ်ပြောင်းတဲ့အလုပ်က အောင်အောင်မြင်မြင်နဲ့ ပြီးဆုံးခဲ့ရင် (&& ကိုသုံးထားတယ်) rm. /$file (နဂို wave ဖိုင်ကို) ဖျက်ပါလို့ ရေးထားတာ ဖြစ်ပါတယ်။ နောက်တချက် သတိပေးချင်တာက mk-16KHz-mono.sh ပရိုဂရမ်ကို ထပ်ခါထပ်ခါ run ရင် ရှိနေတဲ့ wave ဖိုင်တွေကို 16KHz အဖြစ် ပြောင်းပေးမှာမို့ မလိုအပ်တဲ့ ဖိုင်တွေကတိုးတိုးလာမှာ ဖြစ်ပါတယ်။ အောက်ပါ ဥပမာလိုမျိုး  
