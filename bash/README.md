...
(ပြင်ထားတဲ့ corpus ကို ရဲ့ format ""သရက်/Fru ကိုင်းကူးနည်း/AgrK လေး/nolabel လည်း/nolabel သိချင်/nolabel ပါ/nolabel တယ်/nolabel",\_\_AgrK\_\_" ကနေ CSV ဖိုင် format နှစ်ခု ဖြစ်တဲ့ "Fru,AgrK,nolabel,nolabel,nolabel,nolabel,nolabel,\_\_AgrK\_\_" format နဲ့ ""Fru AgrK nolabel nolabel nolabel nolabel nolabel",\_\_AgrK\_\_" အဖြစ်ကိုပြောင်းဖို့အတွက် ရေးခဲ့တဲ့ shell script ပါ)  
