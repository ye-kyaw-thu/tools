...
(ပြင်ဆင်ထားတဲ့ corpus မှာပါတဲ့ manual tagging error ပါတဲ့ စာကြောင်းတွေကို ဖယ်လိုက်ပြီး နဂို word/tag format "သရက်/Fru ကိုင်းကူးနည်း/AgrK လေး/nolabel လည်း/nolabel သိချင်/nolabel ပါ/nolabel တယ်/nolabel",\_\_AgrK\_\_ ဆိုတဲ့ ပုံစံအပြင်၊ tag only CSV ဖိုင် format နှစ်ခုဖြစ်တဲ့ Fru,AgrK,nolabel,nolabel,nolabel,nolabel,nolabel,\_\_AgrK\_\_ ဆိုတဲ့ format နဲ့ "Fru AgrK nolabel nolabel nolabel nolabel nolabel",\_\_AgrK\_\_ ဆိုတဲ့ format တွေအဖြစ်ကိုပါ ပြောင်းဖို့အတွက် ရေးခဲ့တဲ့ bash shell script တစ်ပုဒ်ပါ)  
