...
(argument ကနေ pass လုပ်ပေးလိုက်တဲ့ path/filename ကနေ ဖိုင်နာမည်ကို ဆွဲထုတ်တာ၊ path ကိုပဲ ဆွဲထုတ်တာ၊ extension မပါပဲ ဖိုင်နာမည်ကိုပဲ ဆွဲထုတ်တာ၊ extension ကိုပဲ သပ်သပ် ဆွဲထုတ်ဖို့အတွက် ရေးခဲ့ပါတယ်။)  
