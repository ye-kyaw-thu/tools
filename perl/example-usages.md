...
ဒီ perl script က ကျွန်တော်နဲ့ဒေါက်တာ Utiyama-san တို့ဦးဆောင်ပြီး UCSY ရဲ့ collaboration နဲ့အတူ develop လုပ်ခဲ့ကြတဲ့ NICT, Japan ရဲ့မြန်မာစာ ALT Corpus ထဲက ကနေ မြန်မာစာ စာလုံးတွေကိုပဲ ဆွဲထုတ်ဖို့အတွက် ရေးခဲ့တာပါ။  

ပထမဆုံး ALT Myanamr corpus ရဲ့ ထိပ်ဆုံး စာကြောင်း ၁၀ကြောင်းကိုပဲ print ထုတ်ကြည့်ကြရအောင်။  
```
$ head ./data
...
ရေးထားတဲ့ perl script နဲ့ မြန်မာစာလုံးတွေကိုပဲ ဆွဲထုတ်ပြီး data.myword ဆိုတဲ့ နာမည်နဲ့ သိမ်းမယ်။  
```
